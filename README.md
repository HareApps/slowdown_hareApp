...
## Tech Stack
*    **Component Technology Logic** Python 3.x (via PyScript)
*    **Frontend** HTML5, CSS3
*    **Offline Support** Service Workers & Web Manifest (PWA)
*    **Interactivity** Asyncio for non-blocking timers
## Project Structure
...
## Acknowledgements to
*    **Amarga** for hare_relax.jpg picture
